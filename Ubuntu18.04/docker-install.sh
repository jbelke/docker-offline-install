...
#echo 'deb [arch=amd64] file:///var/deb/apt-mirror/apt.dockerproject.org/repo  ubuntu-bionic main' > /etc/apt/sources.list.d/docker_local.list

echo "deb [arch=amd64] https://download.docker.com/linux/ubuntu \
$(lsb_release -cs) \
stable edge test" > /etc/apt/sources.list.d/docker_local.list
